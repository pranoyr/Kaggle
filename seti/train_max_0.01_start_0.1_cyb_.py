...
def main():
	...
	"save_model_name":"train_max_0.01_start_0.1(cyb).pth"
	}
	wandb.init(name='train_max_0.01_start_0.1(cyb)', 
           project='Seti',
	...
	scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, max_lr=0.01, steps_per_epoch=len(train_loader), epochs=100, pct_start=0.1)
	...
	for epoch in range(start_epoch, 100):
		...
		if (epoch) % 1 == 0:
			...
			if (val_acc > th):
				...
				torch.save(state, 'train_max_0.01_start_0.1(cyb).pth')
